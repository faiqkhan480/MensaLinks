...
import 'package:mensa_links/screens/auth/register_scanner_screen.dart';
...
class AppPages {
  static var list = [
    GetPage(
        name: AppRoutes.SPLASH, binding: SplashBinding(), page: () => Splash()),
    GetPage(
    ...
    GetPage(name: AppRoutes.PIN, page: () => PinScreen()),
    GetPage(
        name: AppRoutes.HOME, binding: HomeBinding(), page: () => HomeScreen()),
    GetPage(name: AppRoutes.CREATEACCOUNT, page: () => CreateAccount()),
    GetPage(
        name: AppRoutes.MANAGEACCOUNT,
        binding: MemberBinding(),
        page: () => ManageAccount()),
    GetPage(name: AppRoutes.REGISTERPAYMENT, page: () => RegisterPayment()),
    GetPage(name: AppRoutes.TRANSFERMONEY, page: () => TransferMoney()),
    GetPage(name: AppRoutes.PROCESSSALRY, page: () => ProcessSalary()),
    GetPage(name: AppRoutes.MEMBERS, page: () => MemberList()),
    GetPage(name: AppRoutes.MEMBEREDIT, page: () => EditMember()),
    GetPage(name: AppRoutes.DEPENDENTCARD, page: () => DependentCard()),
    GetPage(name: AppRoutes.MEMBERSDETAILS, page: () => MemberDetails()),
  ];
}
